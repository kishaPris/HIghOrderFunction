...
// What developers know well is how to write for-in loops in order to iterate through the elements of a collection.\
...
let _ = arrReduce23.removeAll { $0 < 10 }
...
let nameArr = ["Stefano","Brian","Sean","Kate"]

let startWithA = nameArr.contains{$0.first == "A"}

// startWithA == false

let startWiths = nameArr.contains{$0.first == "S"}
// startWithS == true
